<template>
  <div>
    ...
    <div class="row m-0">
      ...
      <div class="col p-4 container-tam container-category">
        <!-- Header -->
        <div class="row">
          <div class="col-auto">
          ...
          <div class="col-auto">
            <h1 class="mb-4 text-primary">Category</h1>
          </div>
        </div>
            ...
            <table class="table table-hover table-bordered table-responsive">
              <thead>
                <tr>
                  <th scope="col">
                    <div class="row">
                      <div class="col">Category / Sub Category</div>
                      <div class="col-auto">
                        <span
              ...
              <tbody>
                ...
                >
                  <td>
                    <span><i class="fa fa-angle-down"></i></span> &nbsp; System
                  </td>
                  <td></td>
